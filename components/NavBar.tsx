...
export default function NavBar() {
  ...
  return (
    <nav className="bg-secondary border-accent border-b-2 px-7 py-3 sm:px-10 md:px-14 lg:px-20 fixed w-full z-50 flex justify-between items-center">
      ...
      <div className="sm:hidden">
        ...
        <div className={`absolute transition-transform top-20 bg-secondary p-10 right-0 h-screen border-l-2 border-accent ${isMenuOpen ? "translate-x-0" : "translate-x-full"}`}>
