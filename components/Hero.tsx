  ...
  return (
    <div className="w-screen h-screen px-20 flex items-center justify-center gap-5">
      <div className="w-full">
        <h1 className="text-5xl font-bold text-primary mb-4">Bienvenido a AnimeZilla</h1>
      ...
      <div className="relative size-full flex justify-center items-center p-5">
        {animes.map((anime, index) => (
          <img
            ...
            className="absolute h-4/6 border-2 border-primary rounded-lg shadow-lg transition-all duration-300 hover:scale-105"
          />
        ))}
      </div>
    </div>
